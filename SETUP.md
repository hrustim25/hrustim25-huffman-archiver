...
Поскольку cpp-pilot-hse -- это публичный репозиторий, сохранять в нем ваши решения не рекомендуется. Но вы можете загружать решения в свой приватный репозиторий student (тот, что My Repository в интерфейсе https://pilot.cpp-hse.org/).
